static class DateUtils{
  ...
  static float dateToUnixEpoch( Date date )
  {
  ...
  static float stringToUnixEpoch( String str )
  {
  ...
  static String unixToPrettyDate( float timestamp ) {
  ...
  static String unixToYear( float timestamp ) {
     java.util.Date time = new java.util.Date( );
  ...
  static String unixToMonth( float timestamp ) {
     java.util.Date time = new java.util.Date( );
  ...
  static String unixToDay( float timestamp ) {
     java.util.Date time = new java.util.Date( );
